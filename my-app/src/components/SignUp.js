  ...
  return (
    <div className="min-h-screen relative bg-[#E6E6FA]">
      ...
      <form
        ...
        className=" h-90 w-3/6 flex my-28 mx-96 absolute bg-white bg-opacity-20 p-4 rounded-lg shadow-2xl backdrop-blur-md"
        // style={{ width: "650px" }}
      >
        <div
          className="w-1/3 pt-36 content-center bg-gradient-to-r from-[#d96a94] to-[#b8a8c4] rounded-lg"
          style={{ width: "250px" }}
        >
        ...
        <div className="w-2/3 p-4">
          ...
          >
            ...
            <Typography variant="p">
              ...
              <Link to="/login" style={{ color: "#d96a94" }}>
                Login
              </Link>
            </Typography>
          </Box>
